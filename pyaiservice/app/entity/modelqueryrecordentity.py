...
class ModelQueryRecordEntity(Base):
    
    __tablename__ = 'TB_MODEL_QUERY_RECORD'
    ...
    def __init__(self, v_model_id, v_batno, v_result, v_score):
        Base.__init__(self)
    ...
    def __repr__(self):
        return '{"id":%r,"model_id":%r, "batno": %r, "result": %r, "score": %r}' \
               % (self.id, self.model_id, self.batno, self.result, self.score)
